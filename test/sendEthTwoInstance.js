...
contract("AdminTest", (accounts) => {
  it("방만들기 동시에 방contract계좌 송금 (인스턴스 admin -> chickenhouse -> orderoom)", async () => {
    ...
    // createRoom 함수 호출!
    await instance.createRoom(0, 8000, 5, "뿌링클", { from: accounts[1], value: 1000000000000000000 });
    console.log("pass2");
    ...
    // matchRoom 함수 호출!
    await instance.matchRoom(0,0, {from: accounts[2], value:1000000000000000000 });
